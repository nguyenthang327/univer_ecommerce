    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item {{ in_array($currentRoute, ['admin.dashboard']) ? 'menu-open' : ''}}" >
                    <a href="{{route('admin.dashboard')}}" class="nav-link {{ in_array($currentRoute, ['admin.dashboard']) ? 'active' : ''}}">
