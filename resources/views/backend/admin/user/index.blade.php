...
@section('title',trans('language.user_list'))
@section('meta')
@stop
    ...
    <section class="content pt-3">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-end flex-wrap">
                <div class="mr-1 mb-2">
                    <a href="{{route('admin.user.index',['refresh'=>'true'])}}" class="btn btn-default text-success d-none d-sm-inline-block"><i class="fal fa-sync"></i> {{trans('language.refresh')}}</a>
                ...
                <div class="actions mb-2">
                    <a href="{{route('admin.user.create')}}" class="btn btn-primary"><i class="fas fa-plus"></i> {{trans('language.add_new')}}</a>
                </div>
            </div>
            <div id="collapseFilter" class="collapse">
                <div class="card mb-3">
                    <div class="card-body border-0">
                        @include('backend.admin.user.partials.form-filter')
                    </div>
                </div>
            </div>
            @if($is_filter)
            ...
            <div class="table-list-data">
                @include('backend.admin.user.partials.list-users')
            </div>
        </div>
    </section>
@stop
