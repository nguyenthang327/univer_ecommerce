                ...
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="text-center">
                                    <div class="form-image">
                                        <img
                                            src="{{ isset($customer->avatar) ? asset('storage/'. $customer->avatar) : asset('images/user-default.png')  }}"
                                        ...
                                        <input type="file"
                                                ...
                                                data-origin="{{isset($customer)?route('admin.customer.avatar',['id'=>$customer->id]):asset('images/user-default.png')}}"
                                                name="avatar"
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <label for="">{{trans('language.lang')}}</label>
                                    <select class="select2-base " name="language_id"  style="width: 100%">
                                        @php
                                            $choose_language = old('language') ? old('language') : (isset($customer->language_id)?$customer->language_id:'');
                                        @endphp
                            ...
                            <div class="form-group">
                                ...
                                <label class="input-group mb-0">
                                    <input type="email" class="form-control {{$errors->first('email') ? 'is-invalid' : ''}}" name="email" placeholder="{{trans('language.enter_email')}}" required
                                           value="{{old('email') ? old('email') : (isset($customer->email) ? $customer->email : '') }}">
                                    <div class="input-group-append">
                                        <div class="input-group-text">
