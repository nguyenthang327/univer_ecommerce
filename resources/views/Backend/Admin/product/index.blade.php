...
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a class="nav-link title">{{ trans('language.product_list') }}</a>
    </li>
@endsection
@section('content')
    @php
    ...
    <section class="content pt-3">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-end flex-wrap">
                <div class="mr-1 mb-2">
                    <a href="{{route('user.product.index',['refresh'=>'true'])}}" class="btn btn-default text-success d-none d-sm-inline-block"><i class="fal fa-sync"></i> {{trans('language.refresh')}}</a>
                ...
                <div class="actions mb-2">
                    <a href="{{ route('user.product.create') }}" class="btn btn-primary ml-2" id="butonAddCategory">
            ...
            <div id="collapseFilter" class="collapse">
                <div class="card mb-3">
                    <div class="card-body border-0">
                        @include('backend.user.product.partials.form-filter')
                    </div>
                </div>
            </div>
            @if(isset($is_filter))
            ...
            <div class="table-list-data">
                @include('backend.user.product.partials.product-list')
            </div>
        </div>
    </section>
@stop
