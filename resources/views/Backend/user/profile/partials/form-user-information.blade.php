                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="text-center">
                                    <div class="form-image">
                                        <img src="{{ route('user.avatar', ['id' => isset($user) ? $user->id : -1]) }}" class="form-image__view" id="avatar_view" alt="preview image">
                                        <input type="file"
                                                class="form-image__file"
                                                id="avatar"
                                                accept=".png, .jpg, .jpeg, .gif"
                                                data-origin="{{isset($user)?route('user.avatar',['id'=>$user->id]):asset('images/user-default.png')}}"
                                                name="avatar"
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{$errors->first('user_name') ? 'is-invalid' : ''}} disabled" name="user_name" placeholder="{{trans('language.enter_user_name')}}" required disabled
                            ...
                            <div class="form-group">
                                <label for="">{{trans('language.lang')}} <span class="text-red"></span></label>
                                    <select class="select2-base disabled" name="language_id"  style="width: 100%">
                                        @php
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{$errors->first('first_name') ? 'is-invalid' : ''}}" name="first_name" placeholder="{{trans('language.enter_first_name')}}" required disabled
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{$errors->first('last_name') ? 'is-invalid' : ''}}" name="last_name" placeholder="{{trans('language.enter_last_name')}}" required disabled
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <label class="input-group mb-0">
                                    <input type="email" class="form-control {{$errors->first('email') ? 'is-invalid' : ''}}" name="email" placeholder="{{trans('language.enter_email')}}" required disabled
                            ...
                            <div class="form-group">
                                ...
                                @for($i=0;$i<count($genders);$i++)
                                    <div class="icheck-primary d-inline mr-4">
                                        <input type="radio" name="gender" id="radioGender{{ $i }}" value="{{ $i }}" {{ ($i===$choose_gender)?'checked':'' }} disabled>
